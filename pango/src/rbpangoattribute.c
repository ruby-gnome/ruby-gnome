    ...
    PangoAttribute* attr;
{
    ...
    return Data_Wrap_Struct(rb_hash_aref(pattrs, FIX2INT(attr->klass->type)), 0, 
...
{
    VALUE tmpklass, pattrstring, pattrint, pattrcolor;
    ...
    MAKE_ATTR(PANGO_ATTR_SCALE, AttrScale, pattr, 1);
