...
#  define RGDA_ERROR(o)          (GDA_CONNECTION_EVENT(RVAL2GOBJ(o)))
#  define RGDA_FIELD_ATTRIBUTES(o) (GDA_COLUMN(RVAL2GOBJ(o)))
#else
...
#if defined(GDA_AT_LEAST_1_3)
#  define RGDA_FIELD_ATTRIBUTES_NEW(o) (GOBJ2RVAL(GDA_COLUMN(o)))
#else
#  define RGDA_ERROR_NEW(o)          (GOBJ2RVAL(GDA_ERROR(o)))
#  define RGDA_CONNECTION_EVENT(o)   (GOBJ2RVAL(GDA_CONNECTION_EVENT(o)))
