...
/* $Id: rbgnome-app-helper.c,v 1.5 2002/09/25 17:17:24 tkubo Exp $ */
    ...
    VALUE mGnome, gnoApp;
{
    ...
    rb_define_const(gnoApp, "GNOME_APP_UI_SUBTREE_STOCK", INT2FIX(GNOME_APP_UI_SUBTREE_STOCK));
    ...
    rb_define_const(gnoApp, "CONFIGURABLE_ITEM_EXIT", INT2FIX(GNOME_APP_CONFIGURABLE_ITEM_EXIT));
