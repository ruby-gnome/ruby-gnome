/* $Id: rbgnome-dock-band.c,v 1.1 2002/05/19 12:39:25 mutoh Exp $ */
...
Init_gnome_dock_band()
{
     ...
     * instance methods
     */
    rb_define_method(gnoDockBand, "initialize",
		     dockband_initialize, 0);
    rb_define_method(gnoDockBand, "set_orientation",
		     dockband_set_orientation, 1);
    rb_define_method(gnoDockBand, "get_orientation",
		     dockband_get_orientation, 0);
    rb_define_method(gnoDockBand, "insert",
		     dockband_insert, 3);
    rb_define_method(gnoDockBand, "prepend",
		     dockband_prepend, 2);
    rb_define_method(gnoDockBand, "append",
		     dockband_append, 2);
    rb_define_method(gnoDockBand, "set_child_offset",
		     dockband_set_child_offset, 2);
    rb_define_method(gnoDockBand, "get_child_offset",
		     dockband_get_child_offset, 1);
#if 0
    rb_define_method(gnoDockBand, "move_child",
		     dockband_move_child, 2);
#endif
    rb_define_method(gnoDockBand, "get_num_children",
		     dockband_get_num_children, 0);
    rb_define_method(gnoDockBand, "drag_begin",
		     dockband_drag_begin, 1);
    rb_define_method(gnoDockBand, "drag_to",
		     dockband_drag_to, 3);
    rb_define_method(gnoDockBand, "drag_end",
		     dockband_drag_end, 1);
    rb_define_method(gnoDockBand, "get_item_by_name",
		     dockband_get_item_by_name, 1);
    rb_define_method(gnoDockBand, "layout_add",
		     dockband_layout_add, 3);
}
