...
#define RVAL2GPDRF(obj) (RVAL2GFLAGS(obj, GNOME_TYPE_PRINTUI_PRINT_DIALOG_RANGE_FLAGS))
#define GPRT2RVAL(obj) (GENUM2RVAL(obj, GNOME_TYPE_PRINTUI_PRINT_RANGE_TYPE))
#define GPRF2RVAL(obj) (GENUM2RVAL(obj, GNOME_TYPE_PRINTUI_PRINT_DIALOG_RANGE_FLAGS))
