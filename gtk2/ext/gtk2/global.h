...
G_GNUC_INTERNAL void Init_agentry(void);
G_GNUC_INTERNAL void Init_accel_key(void);
G_GNUC_INTERNAL void Init_gtk_accel_label(void);
G_GNUC_INTERNAL void Init_accel_map(void);
...
G_GNUC_INTERNAL void Init_icon_factory(void);
G_GNUC_INTERNAL void Init_gtk_iconinfo(void);
G_GNUC_INTERNAL void Init_icon_set(void);
G_GNUC_INTERNAL void Init_icon_size(void);
G_GNUC_INTERNAL void Init_icon_source(void);
...
G_GNUC_INTERNAL void Init_invisible(void);
...
G_GNUC_INTERNAL void Init_sizegrp(void);
...
G_GNUC_INTERNAL void Init_txt_appearance(void);
G_GNUC_INTERNAL void Init_txt_attr(void);
...
G_GNUC_INTERNAL void Init_txt_tt(void);
