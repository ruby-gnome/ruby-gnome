...
begin
  config_cmd = with_config("pkg-config", "pkg-config libbonobo-2.0 libbonoboui-2.0")
  config_libs = "--libs"
  ...
  $CFLAGS = '-DORBIT2=1 -D_REENTRANT  -I#{prefix}/include/libbonobo-2.0 -I#{prefix}/include/glib-2.0 -I#{prefix}/lib/glib-2.0/include -I#{prefix}/include/orbit-2.0 -I#{prefix}/include/bonobo-activation-2.0 -I#{prefix}/include/linc-1.0 -I#{prefix}/include/libxml2 -I#{prefix}/include/libbonoboui-2.0 -I#{prefix}/include/libgnomecanvas-2.0 -I#{prefix}/include/libgnome-2.0 -I#{prefix}/include/libart-2.0 -I#{prefix}/include/pango-1.0 -I#{prefix}/include/freetype2 -I#{prefix}/include/gtk-2.0 -I#{prefix}/lib/gtk-2.0/include -I#{prefix}/include/atk-1.0 -I#{prefix}/include/Xft2 -I#{prefix}/X11R6/include -I#{prefix}/include/gconf/2 -I#{prefix}/include/gnome-vfs-2.0 -I#{prefix}/lib/gnome-vfs-2.0/include '
  $libs = '-L#{prefix}/X11R6/lib -lbonoboui-2 -lgnomecanvas-2 -lgnome-2 -lart_lgpl_2 -lpangoft2-1.0 -lgtk-x11-2.0 -lgdk-x11-2.0 -latk-1.0 -lgdk_pixbuf-2.0 -lpangoxft-1.0 -lpangox-1.0 -lpango-1.0 -lbonobo-2 -lgconf-2 -lgnomevfs-2 -lbonobo-activation -lORBit-2 -lxml2 -lz -lm -llinc -lgmodule-2.0 -ldl -lgobject-2.0 -lgthread-2.0 -lpthread -lglib-2.0 '
end
