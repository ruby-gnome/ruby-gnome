...
rg_type_name(VALUE self)
{
    ...
    info = SELF(self);
    return CSTR2RVAL(gi_object_info_get_type_name(info));
}
...
rg_type_init(VALUE self)
{
    ...
    info = SELF(self);
    return CSTR2RVAL(gi_object_info_get_type_init_function_name(info));
}
...
rg_abstract_p(VALUE self)
{
    ...
    info = SELF(self);
    return CBOOL2RVAL(gi_object_info_get_abstract(info));
}
...
rg_fundamental_p(VALUE self)
{
    ...
    info = SELF(self);
    return CBOOL2RVAL(gi_object_info_get_fundamental(info));
}
...
rg_parent(VALUE self)
{
    ...
    info = SELF(self);
    return GI_BASE_INFO2RVAL_WITH_UNREF(gi_object_info_get_parent(info));
}
...
rg_n_interfaces(VALUE self)
{
    ...
    info = SELF(self);
    return INT2NUM(gi_object_info_get_n_interfaces(info));
}
...
rg_get_interface(VALUE self, VALUE rb_n)
{
    ...
    info = SELF(self);
    n = NUM2INT(rb_n);
    return GI_BASE_INFO2RVAL_WITH_UNREF(gi_object_info_get_interface(info, n));
}
...
rg_n_fields(VALUE self)
{
    ...
    info = SELF(self);
    return INT2NUM(gi_object_info_get_n_fields(info));
}
...
rg_get_field(VALUE self, VALUE rb_n)
{
    ...
    info = SELF(self);
    n = NUM2INT(rb_n);
    return GI_BASE_INFO2RVAL_WITH_UNREF(gi_object_info_get_field(info, n));
}
...
rg_get_field_value(VALUE self, VALUE rb_object, VALUE rb_n)
{
    ...
    info = SELF(self);
    n = NUM2INT(rb_n);
    field_info = gi_object_info_get_field(info, n);
...
rg_n_properties(VALUE self)
{
    ...
    info = SELF(self);
    return INT2NUM(gi_object_info_get_n_properties(info));
}
...
rg_get_property(VALUE self, VALUE rb_n)
{
    ...
    info = SELF(self);
    n = NUM2INT(rb_n);
    return GI_BASE_INFO2RVAL_WITH_UNREF(gi_object_info_get_property(info, n));
}
...
rg_n_methods(VALUE self)
{
    ...
    info = SELF(self);
    return INT2NUM(gi_object_info_get_n_methods(info));
}
...
rg_get_method(VALUE self, VALUE rb_n_or_name)
{
    ...
    if (RB_TYPE_P(rb_n_or_name, T_FIXNUM)) {
        ...
        function_info = gi_object_info_get_method(info, n);
    } else {
        const gchar *name;
        name = RVAL2CSTR(rb_n_or_name);
        function_info = gi_object_info_find_method(info, name);
    }
...
rg_n_signals(VALUE self)
{
    ...
    info = SELF(self);
    return INT2NUM(gi_object_info_get_n_signals(info));
}
...
rg_get_signal(VALUE self, VALUE rb_n)
{
    ...
    info = SELF(self);
    n = NUM2INT(rb_n);
    return GI_BASE_INFO2RVAL_WITH_UNREF(gi_object_info_get_signal(info, n));
}
...
rg_n_vfuncs(VALUE self)
{
    ...
    info = SELF(self);
    return INT2NUM(gi_object_info_get_n_vfuncs(info));
}
...
rg_get_vfunc(VALUE self, VALUE rb_n_or_name)
{
    ...
    if (RB_TYPE_P(rb_n_or_name, T_FIXNUM)) {
        gint n;
        n = NUM2INT(rb_n_or_name);
        vfunc_info = gi_object_info_get_vfunc(info, n);
    } else {
        const gchar *name;
        name = RVAL2CSTR(rb_n_or_name);
        vfunc_info = gi_object_info_find_vfunc(info, name);
    }
...
rg_n_constants(VALUE self)
{
    ...
    info = SELF(self);
    return INT2NUM(gi_object_info_get_n_constants(info));
}
...
rg_get_constant(VALUE self, VALUE rb_n)
{
    ...
    info = SELF(self);
    n = NUM2INT(rb_n);
    return GI_BASE_INFO2RVAL_WITH_UNREF(gi_object_info_get_constant(info, n));
}
...
rg_class_struct(VALUE self)
{
    ...
    info = SELF(self);
    return GI_BASE_INFO2RVAL_WITH_UNREF(gi_object_info_get_class_struct(info));
}
...
rg_unref_function(VALUE self)
{
    ...
    info = SELF(self);
    return CSTR2RVAL(gi_object_info_get_unref_function_name(info));
}
...
rg_ref_function(VALUE self)
{
    ...
    info = SELF(self);
    return CSTR2RVAL(gi_object_info_get_ref_function_name(info));
}
...
rg_set_value_function(VALUE self)
{
    ...
    info = SELF(self);
    return CSTR2RVAL(gi_object_info_get_set_value_function_name(info));
}
...
rg_get_value_function(VALUE self)
{
    ...
    info = SELF(self);
    return CSTR2RVAL(gi_object_info_get_get_value_function_name(info));
}
