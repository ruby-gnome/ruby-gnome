...
rg_n_prerequisites(VALUE self)
{
    ...
    info = SELF(self);
    return INT2NUM(gi_interface_info_get_n_prerequisites(info));
}
...
rg_get_prerequisite(VALUE self, VALUE rb_n)
{
    ...
    info = SELF(self);
    n = NUM2INT(rb_n);
    return GI_BASE_INFO2RVAL_WITH_UNREF(gi_interface_info_get_prerequisite(info, n));
}
...
rg_n_properties(VALUE self)
{
    ...
    info = SELF(self);
    return INT2NUM(gi_interface_info_get_n_properties(info));
}
...
rg_get_property(VALUE self, VALUE rb_n)
{
    ...
    info = SELF(self);
    n = NUM2INT(rb_n);
    return GI_BASE_INFO2RVAL_WITH_UNREF(gi_interface_info_get_property(info, n));
}
...
rg_n_methods(VALUE self)
{
    ...
    info = SELF(self);
    return INT2NUM(gi_interface_info_get_n_methods(info));
}
...
rg_n_signals(VALUE self)
{
    ...
    info = SELF(self);
    return INT2NUM(gi_interface_info_get_n_signals(info));
}
...
rg_n_vfuncs(VALUE self)
{
    ...
    info = SELF(self);
    return INT2NUM(gi_interface_info_get_n_vfuncs(info));
}
...
rg_n_constants(VALUE self)
{
    ...
    info = SELF(self);
    return INT2NUM(gi_interface_info_get_n_constants(info));
}
...
rg_get_constant(VALUE self, VALUE rb_n)
{
    ...
    info = SELF(self);
    n = NUM2INT(rb_n);
    return GI_BASE_INFO2RVAL_WITH_UNREF(gi_interface_info_get_constant(info, n));
}
...
rg_iface_struct(VALUE self)
{
    ...
    info = SELF(self);
    return GI_BASE_INFO2RVAL_WITH_UNREF(gi_interface_info_get_iface_struct(info));
}
