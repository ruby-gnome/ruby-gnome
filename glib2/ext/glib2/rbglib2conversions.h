...
#define RVAL2GREGEXCOMPILEOPTIONSFLAGS(o)  (RVAL2GFLAGS(o, G_TYPE_REGEX_COMPILE_OPTIONS_FLAGS))
#define RVAL2GREGEXMATCHOPTIONSFLAGS(o)  (RVAL2GFLAGS(o, G_TYPE_REGEX_MATCH_OPTIONS_FLAGS))
