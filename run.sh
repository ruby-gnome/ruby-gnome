...
RUBYLIB="${source_dir}/graphene1/lib:${RUBYLIB}"
RUBYLIB="${source_dir}/gsk4/lib:${RUBYLIB}"
...
RUBYLIB="${source_dir}/vte4/lib:${RUBYLIB}"
...
RUBYLIB="${source_dir}/gtksourceview4/lib:${RUBYLIB}"
RUBYLIB="${source_dir}/gtksourceview5/lib:${RUBYLIB}"
...
RUBYLIB="${source_dir}/adwaita/lib:${RUBYLIB}"
